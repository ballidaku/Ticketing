package example.com.ballidaku.mPin;
...
public class PinLockView extends RecyclerView
{
    ...
    private void init(AttributeSet attributeSet, int defStyle) {
        ...
        try {
            ...
            mTextColor = typedArray.getColor(R.styleable.PinLockView_keypadTextColor, ResourceUtils.getColor(getContext(), R.color.colorWhite));
            ...
            mDeleteButtonPressedColor = typedArray.getColor(R.styleable.PinLockView_keypadDeleteButtonPressedColor, ResourceUtils.getColor(getContext(), R.color.colorGray));
        } finally {
            typedArray.recycle();
        }
...
//        mCustomizationOptionsBundle.setButtonSize(mButtonSize);
        ...
        int ts=R.dimen._22sdp;
        int bs=R.dimen._60sdp;

       // Log.e("ts  "+ts+"    mTextSize  "+mTextSize   ,"bs  "+bs+"    mButtonSize  "+mButtonSize);
        mCustomizationOptionsBundle.setTextSize((int)getResources().getDimension(ts));
        mCustomizationOptionsBundle.setButtonSize((int)getResources().getDimension(bs));
...
//        Log.e("mTextSize "+mTextSize,"mButtonSize "+mButtonSize);
    ...
    private void initView() {
        ...
        addItemDecoration(new ItemSpaceDecoration(mHorizontalSpacing, mVerticalSpacing, 3, true));
